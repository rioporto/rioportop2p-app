-- Blog Schema for Rio Porto P2P (VERSÃO CORRIGIDA)
-- Esta versão remove as referências a 'role' e usa 'is_admin'
...
-- Views (CORRIGIDAS - sem referência a 'role')
...
-- Admins can manage all posts (CORRIGIDO - usa is_admin)
