-- VERSÃO COMPLETA E CORRIGIDA DA MIGRATION 001
...
-- KYC Documents (CRIAR ANTES DOS ÍNDICES!)
...
BEGIN
    ...
    -- Cryptocurrencies
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_cryptocurrencies_updated_at') THEN
...
CREATE POLICY "Users can manage related transactions" ON transactions
