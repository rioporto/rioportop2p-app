    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://maps.googleapis.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob:; connect-src 'self' https://*.supabase.co https://api.stackauth.com https://pro-api.coinmarketcap.com https://api.binance.com https://api.coingecko.com https://min-api.cryptocompare.com wss://*.supabase.co; frame-ancestors 'none'; base-uri 'self'; form-action 'self';"
          }
        ],
      },
    ];
